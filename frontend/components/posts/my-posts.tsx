...
import { describeLoadError } from "@/lib/posts/errors";
import { FEED_NOTICES } from "@/lib/posts/notices";
import { getPostActor } from "@/lib/posts/permissions";
import { fetchPostPage, postKeys } from "@/lib/queries/posts";
...
export function MyPosts({ user }: MyPostsProps) {
  ...
  const list = useInfiniteQuery({
    queryKey: postKeys.mine(user.id),
    queryFn: ({ pageParam }) => fetchPostPage(pageParam, user.id),
