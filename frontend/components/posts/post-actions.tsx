...
import { describeSaveError, hasStatus } from "@/lib/posts/errors";
import type { PostActor } from "@/lib/posts/permissions";
import { feedNoticeUrl } from "@/lib/posts/notices";
import { forgetPost } from "@/lib/queries/post-mutations";
...
export function PostDeleteButton({
  ...
  const deleteMutation = useMutation({
    mutationFn: (reason?: string) => deletePost(post.id, reason),
    onSuccess: () => {
      forgetPost(queryClient, post.id);
      setConfirming(false);
