...
import { getPostChanges, hasPostChanges } from "@/lib/posts/changes";
import { splitPostFormErrors } from "@/lib/posts/errors";
import {
  POST_BODY_MAX,
  POST_TITLE_MAX,
  postFormSchema,
...
// (lib/schemas/post.ts) validate before anything is sent: title and body are
