...
import { describeLoadError, isPostNotFound } from "@/lib/posts/errors";
import { feedNoticeUrl } from "@/lib/posts/notices";
import { getPostActor } from "@/lib/posts/permissions";
import { fetchPost, postKeys } from "@/lib/queries/posts";
...
export default function PostPage() {
  ...
  // lib/query-client.tsx), so "not found" shows straight away.
